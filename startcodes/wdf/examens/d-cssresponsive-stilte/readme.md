...
7. **copyright en sociale links** — staan standaard onder elkaar, gecentreerd, met `10px` ertussen; vanaf `600px` naast elkaar, met de vrije ruimte ertussen

## Screenshots

Op een smal scherm (500px):

<img src="img/screenshot-500px.png" alt="" width="400">
