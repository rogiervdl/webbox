...
1. Declareer constanten voor het aantal sterren (5) en een minimum berichtlengte (10)
...
4. Koppel aan alle sterren een klik-event:
   ...
   - highlight de sterren: voeg de class `actief` toe aan elke ster tot en met de waarde, en verwijder ze bij de rest
5. Bij klik op *Versturen*:
   - wis de melding onder de textarea
   - pas eenvoudige validatie toe: als het commentaar minder dan 10 tekens bevat, toon "Schrijf minstens 10 tekens." in de melding
   - als alles geldig is: toon de samenvatting in de uitvoer-`div`. Als het tekenen van de sterren te moeilijk is, vervang het dan door een tekst, bv. `4 sterren`
